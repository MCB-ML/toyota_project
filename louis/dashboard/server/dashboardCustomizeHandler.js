...
export async function handleDashboardCustomizeRequest(req, res, { dataDir }) {
  ...
  try {
    ...
    await runDashboardPipeline({ message, history: history || [], dashboardState }, { dataDir, sendEvent })
  } catch (err) {
