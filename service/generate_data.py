...
Reads parquet files from ../data/hnd_svc/ and outputs JSON summaries to frontend/public/data/.
Run from the service/ directory: python generate_data.py
"""
...
OUT_DIR = Path(__file__).parent / "service" / "frontend" / "public" / "data"
