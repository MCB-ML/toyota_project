    ...
    <div className="w-full min-w-[280px] rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
      ...
      {previewWidget && (
        <div className="px-3.5 py-3">
          <WidgetErrorBoundary resetKey={`${previewWidget.id || previewWidget.type}:${previewWidget.title || ''}`}>
            <GeneratedWidget name={previewWidget.type} props={previewWidget.props} objectSpec={previewWidget.objectSpec} />
          </WidgetErrorBoundary>
        </div>
      )}
