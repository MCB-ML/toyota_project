...
/* ─────────── 딜러 마스터 (계정 접근제어의 기준 키) ───────────
   dealer / dealerId: 둘 다 딜러명(DEALER_NM). "토요타 강남" 같은 딜러명 자체가 딜러를 구분하는
     유일 키이자 쿼리 조건이다(예: WHERE dealer_name = '토요타 강남'). AI365 로그인 응답 name으로
     이 값을 받아, SelectAccount가 목록을 그 딜러 하나로 필터하고, 이후 text2sql 쿼리 생성 시
     본인 딜러 데이터만 조회되도록 조건으로 주입한다(추후 적용). 별도 코드형 ID는 두지 않는다.
   ※ 부서명이 TMKR / Admin 이면 전체 딜러(본사) 권한 — 이 목록에는 포함하지 않는다.
   ※ 실제 판매/서비스 더미 데이터는 아래 각 섹션이 자체 dealerId를 쓰며 이 마스터와 별개다. */
export const dealerMaster = [
  { dealerId: '토요타 강남', dealer: '토요타 강남', brand: 'Toyota', region: '서울' },
  { dealerId: '토요타 서초', dealer: '토요타 서초', brand: 'Toyota', region: '서울' },
  { dealerId: '토요타 용산', dealer: '토요타 용산', brand: 'Toyota', region: '서울' },
  { dealerId: '토요타 분당', dealer: '토요타 분당', brand: 'Toyota', region: '경기' },
  { dealerId: '토요타 대전', dealer: '토요타 대전', brand: 'Toyota', region: '대전' },
  { dealerId: '토요타 대구', dealer: '토요타 대구', brand: 'Toyota', region: '대구' },
  { dealerId: '토요타 광주', dealer: '토요타 광주', brand: 'Toyota', region: '광주' },
  { dealerId: '토요타 부산', dealer: '토요타 부산', brand: 'Toyota', region: '부산' },
  { dealerId: '렉서스 강남', dealer: '렉서스 강남', brand: 'Lexus', region: '서울' },
  { dealerId: '렉서스 용산', dealer: '렉서스 용산', brand: 'Lexus', region: '서울' },
  { dealerId: '렉서스 분당', dealer: '렉서스 분당', brand: 'Lexus', region: '경기' },
  { dealerId: '렉서스 인천', dealer: '렉서스 인천', brand: 'Lexus', region: '인천' },
  { dealerId: '렉서스 대전', dealer: '렉서스 대전', brand: 'Lexus', region: '대전' },
  { dealerId: '렉서스 대구', dealer: '렉서스 대구', brand: 'Lexus', region: '대구' },
  { dealerId: '렉서스 광주', dealer: '렉서스 광주', brand: 'Lexus', region: '광주' },
  { dealerId: '렉서스 부산', dealer: '렉서스 부산', brand: 'Lexus', region: '부산' },
]
